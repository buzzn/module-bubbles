...
function (_Component) {
  ...
  _createClass(Root, [{
    ...
    value: function componentDidMount() {
      ...
      dispatch({
        type: _actions.constants.SET_API_PARAMS,
        apiUrl: 'http://localhost:3000',
        apiPath: '/api/display/groups'
      });
      dispatch({
        type: _actions.constants.SET_TOKEN,
        token: 'token'
      });
      dispatch({
    ...
    value: function render() {
      return _react.default.createElement("div", null, _react.default.createElement(_bubbles_wrapper.default, null));
    }
  }, {
